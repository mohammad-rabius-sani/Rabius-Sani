        ...
        button.addEventListener('click', function(e) {
            ...
            if (project) {
                ...
                if (project.image) {
                    ...
                    contentHTML += `
                        <div class="mb-6 flex justify-center items-center bg-slate-100 dark:bg-slate-800 p-8 rounded-lg">
                ...
                if (modalGithubLink) {
                    ...
                    if (project.github && project.github.startsWith('https://github.com/')) {
                        ...
                        // Make the GitHub button more prominent
                        modalGithubLink.classList.add('bg-primary-600', 'hover:bg-primary-700', 'text-white', 'cursor-pointer');
                        
                        // Add a click event listener as a backup
                        modalGithubLink.onclick = function(e) {
                            e.preventDefault();
